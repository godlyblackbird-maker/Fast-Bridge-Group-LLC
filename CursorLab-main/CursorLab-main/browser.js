// Browser-compatible version of CursorLab
(function(global) {
  'use strict';
  ...
  class CursorLab {
    ...
    createCustomTrail() {
      ...
      const animate = () => {
        ...
        const delay = this.trailDelayValue || 0.1;
  ...
  CursorLab.setCursorTrail = function(trailType) {
    if (!global.cursorLabInstance) {
      global.cursorLabInstance = new CursorLab();
    }
    return global.cursorLabInstance.setCursorTrail(trailType);
  };
  ...
  CursorLab.trailDelay = function(delay) {
    ...
    return global.cursorLabInstance.trailDelay(delay);
  };
  ...
  CursorLab.setSize = function(widthOrRadius, height) {
    ...
    return global.cursorLabInstance.setSize(widthOrRadius, height);
  };
  ...
  CursorLab.setThickness = function(thickness) {
    ...
    return global.cursorLabInstance.setThickness(thickness);
  };
  ...
  CursorLab.setColor = function(color) {
    ...
    return global.cursorLabInstance.setColor(color);
  };
  ...
  CursorLab.setCustomCursor = function(cursorType, param1, param2) {
    ...
    return global.cursorLabInstance.setCustomCursor(cursorType, param1, param2);
  };
  ...
  CursorLab.setCustomStyle = function(cssStyles) {
    ...
    return global.cursorLabInstance.setCustomStyle(cssStyles);
  };
  ...
  CursorLab.startTrail = function() {
    ...
    return global.cursorLabInstance.startTrail();
  };

  CursorLab.setDefault = function() {
    if (global.cursorLabInstance) {
      return global.cursorLabInstance.setDefault();
    }
  };
  ...
  CursorLab.setNormalCursor = function() {
    ...
    return global.cursorLabInstance.setNormalCursor();
  };

  CursorLab.destroy = function() {
    if (global.cursorLabInstance) {
      global.cursorLabInstance.destroy();
      global.cursorLabInstance = null;
    }
  };
